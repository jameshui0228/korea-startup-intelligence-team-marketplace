...
누구나 **허구김**(`korea-startup-intelligence`) 플러그인 0.7.0을 Codex에 설치할 수 있도록 만든 공개 마켓플레이스입니다.
API 키나 예약 자동화 없이 사용자가 호출한 현재 Codex 작업에서 공개 SNS·채용·특허·표준·논문·기술 가격·조달·앱·커머스·펀딩·규제·공식 통계 원문을 조사합니다. 최근 변화에서 30개 창업 가설을 발산하고 10개를 반증해 3개를 선별합니다. 참신함, 시의성, 근거, 실행성을 분리하며 평범한 AI·통합 플랫폼 재포장을 탈락시킵니다. 이후 검토 근거를 초기 시장공백, 아이디어 검증, 창업자 시간·예산, 실행·보류·폐기 관리에 연결합니다. 공개 웹 표본은 플랫폼 전체 실시간 수집이 아니며 사업 성공이나 트렌드 선행성을 보장하지 않습니다. [76개 개선 항목의 구현·대기 상태](plugins/korea-startup-intelligence/ACCEPTANCE_76.md)를 확인해 주세요.
