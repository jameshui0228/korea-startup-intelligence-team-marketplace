...
class WorkspaceTest(unittest.TestCase):
    ...
    def test_old_workspace_config_gets_safe_product_defaults(self):
        ...
        self.store = Store(self.workspace)
        self.assertEqual(self.store.config["workspace_profile_version"], 8)
        ...
        self.assertEqual(self.store.config["discovery_mode"], "frontier_then_validation")
        self.assertEqual(self.store.config["frontier_targets"], {"raw": 30, "semifinal": 10, "shortlist": 3})
