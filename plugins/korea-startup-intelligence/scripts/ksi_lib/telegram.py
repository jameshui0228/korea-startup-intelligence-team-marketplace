...
CONNECTION_CHECK = "허구김 연결 확인\n\n확인하신 개인 대화로 수동 공유를 할 수 있습니다. 이 메시지는 연결 시험이며 창업 아이디어나 트렌드 분석 결과가 아닙니다.\n\n허구김은 예약 자동화를 사용하지 않으며 사용자가 명시적으로 요청한 공유만 처리합니다. 선정·수상·예측 정확도를 보장하지 않습니다."
DELIVERY_CHECK = "허구김 수동 전송 점검\n\n업그레이드한 발송 경로로 보낸 시험 메시지입니다. 창업 아이디어나 예약 실행 완료 알림은 아닙니다.\n\n허구김은 예약 자동화를 사용하지 않습니다. 전송 결과가 불명확하면 자동 재전송하지 않고 확인 대상으로 남깁니다."
